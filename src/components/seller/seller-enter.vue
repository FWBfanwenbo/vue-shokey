        ...
        <section class="reg-center">
            <div class="form-wrapper inner">
                ...
                <form action="" id="reg-form">
                    ...
                    <div class="form-group">
                        <input @change="checkQQ" type="text" placeholder="请输入联系QQ（必填）" name="qq" v-model="qq">
                        <span class="Validform_checktip" :class="{'Validform_error':msgQQ}">{{msgQQ}}</span>
                    </div>
                    <input type="button" class="reg-submit" @click="sellerResiter" value="同意注册协议并提交">
                </form>
            </div>
            <keep-alive>
        ...
        methods:{
            checkphone:function(){
                ...
                if(this.phone==""){
                    ...
                    this.$post('/api/Seller.ashx?command=SellerCheckPhone',                        JSON.stringify({
                        phone: that.phone
                    })).then((res)=>{
                        if(res.data=='ok'){
            ...
            sellerResiter(){
                var that=this;
                if(this.msgphone&&this.msgpassword){
                    this.$post('/api/Seller.ashx?command=SellerRegister',
                        JSON.stringify({
                            phone: that.phone,
                            pass: that.pass,
